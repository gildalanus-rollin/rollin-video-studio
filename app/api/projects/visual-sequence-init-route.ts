...
export async function POST(
  ...
  try {
    ...
    // Traer todos los assets del proyecto (fotos y videos)
    ...
    // Solo insertar los assets que no están en la secuencia todavía
    ...
    if (newAssets.length === 0) {
      return NextResponse.json({
        ok: true,
        skipped: true,
        message: "Todos los assets ya están en la secuencia",
      });
    }
